...
<body>
	...
	<div class="container">
				...
				<form role="form" id="createProductForm">
					<div class="form-group">
						<label for="tblProductName">Product Name</label> <input
							type="email" class="form-control" id="tbProductName"
							placeholder="Enter product name">
					</div>
					<div class="form-group">
						<label for="tbProductQty">Product Quantity</label> <input
							type="password" class="form-control" id="tbProductQty"
		...
		<div class="page-header">[Server Console]</div>
	...
	$(document).ready(function() {
		...
		$("#btnSubmitAll").bind("click", function() {
			var productList = [];			
